import torch
from helper_functions import build_model, plot_loss_graph_ft, plot_accuracy_graph_ft, transform_handwritten_alphabet_dataset, wordle_alphabet_dataset_loader
...
def train_one_epoch(model, optimizer, train_loader, epoch):
    ...
    torch.save(model.state_dict(), f'models/finetune_model_{epoch}.pth')
    torch.save(optimizer.state_dict(), f'models/finetune_optimizer_{epoch}.pth')
